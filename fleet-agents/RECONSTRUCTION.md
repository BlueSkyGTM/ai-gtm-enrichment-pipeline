# RECONSTRUCTION.md — fleet-agents Complete System Guide

This document teaches a new Claude Code session with zero prior memory how to rebuild the entire fleet-agents pipeline from scratch and produce an identical working system. Read it in full before touching any file.
